...
import { CheckCircle, XCircle, Wifi, Mic, Camera, Clock, Lightbulb } from 'lucide-react-native';
      ...
      <View style={styles.actionButtons}>
        ...
        >
          <TouchableOpacity
            ...
            onPress={() => isReady && navigation.navigate('VideoSession', { mentor, sessionDetails })}
            disabled={!isReady}
          >
