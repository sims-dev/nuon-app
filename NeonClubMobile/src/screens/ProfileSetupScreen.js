...
const ProfileSetupScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Use /auth/register endpoint for profile completion
      ...
      if (response.data?.success) {
        ...
        newUser.profileIncomplete = !isProfileComplete;
        ...
        // Update auth context
        setToken(newToken);
        updateUser({ ...newUser, profileIncomplete: !isProfileComplete });
  ...
  return (
    <ErrorBoundary>
      <View style={styles.container}>
        ...
        <KeyboardAvoidingView style={styles.keyboardContainer} behavior={Platform.OS === 'ios' ? 'padding' : 'height'} keyboardVerticalOffset={Platform.OS === 'ios' ? 40 : 0}>
...
const styles = StyleSheet.create({
  ...
  scrollContainer: {
    padding: 20,
    paddingBottom: 140, // Increased padding to ensure buttons are always visible above keyboard
  },
  card: {
    backgroundColor: '#ffffff',
    borderRadius: 16,
  ...
  primaryButton: {
    ...
    borderRadius: 24,
    padding: 14, // Reduced padding for more compact buttons
    alignItems: 'center',
    marginBottom: 12,
    shadowColor: '#6366f1',
    ...
    shadowRadius: 8,
    elevation: 6,
    minHeight: 48, // Reduced minimum height for more compact design
  },
  primaryButtonText: {
    color: '#ffffff',
    fontSize: 18,
