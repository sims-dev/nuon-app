...
const EngageDetailsScreen = ({ navigation, route }) => {
  ...
  const handlePurchase = async () => {
    if (item.price === 0) {
      ...
      setIsLoading(true);
      try {
        await api.post(`/engage/activities/${item._id}/register`, {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.infoCard}>
            {item.date && (
              <View style={styles.infoRow}>
                <SvgXml xml={calendarSvg} width={20} height={20} color="#6B7280" />
            ...
            {item.time && (
              <View style={styles.infoRow}>
                <SvgXml xml={clockSvg} width={20} height={20} color="#6B7280" />
                <View style={styles.infoText}>
            ...
            {item.location && (
              <View style={styles.infoRow}>
                <SvgXml xml={mapPinSvg} width={20} height={20} color="#6B7280" />
                <View style={styles.infoText}>
            ...
            {item.enrolled && (
              <View style={styles.infoRow}>
                <SvgXml xml={usersSvg} width={20} height={20} color="#6B7280" />
                <View style={styles.infoText}>
          ...
          {(item.type === 'Mental Wellness' || item.type === 'Wellness Workshop' || item.type === 'Wellness Session') && (
          ...
          {/* Why Fitness Matters */}
          {(item.type === 'Challenge' || item.type === 'Video Series' || item.type === 'Fitness Program' || item.type === 'Nutrition Program') && (
